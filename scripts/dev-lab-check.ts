...
ok('dev-lab is on the authed stack behind root/grants, not a PRE_LAUNCH_DEV-only route');
...
ok('You crash/push probes are PRE_LAUNCH_DEV-required, not static production imports');
