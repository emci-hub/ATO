...
insert into public.question_bank_pool (axis, category, prompt, options, source) values
  ...
  ('self_efficacy', 'cat_agency', 'Everyone at the table already knows their order. You don''t.', '[{"text":"I panic-order whatever''s closest","value":0.2},{"text":"Takes me a sec but I land on something","value":0.5},{"text":"I ask what everyone else got","value":0.8}]'::jsonb, 'authored'),
