...
- **Do:** Apple Developer Program already enrolled (see M0). Remaining: Individual vs Organization still open; Stage 8 items 4–5 (floor sweep, legal), then submit the TestFlight build. $99 USD/yr already in play.
