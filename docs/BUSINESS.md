...
This runs parallel to the technical Stages/Waves in archive/OLD_PLAN.md. It does not block them. Move to the next milestone when its trigger is true, not on a calendar date.
