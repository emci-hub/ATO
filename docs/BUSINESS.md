...
- **Do:** Apple Developer Program already enrolled (see M0). Remaining: Individual vs Organization still open; emci connects Sentry DSN; Stage 8 item 5 (legal + landing copy, not Cursor); then submit the TestFlight build. $99 USD/yr already in play.
