...
- **Plan framing:** ATO_PLAN_v2.md is a working reference, not a locked spec. Stage 11's first 9 trait axes are in; extra axes / Explore / three-path intake / Reload are decided in that file, not built. Next Wave 1.5 box remains Stage 12. Crisis / coach-label / diagnosis-avoidance / App Store floor items in the plan are compliance-grounded.
