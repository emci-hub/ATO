...
- **Crisis card:** region from device locale/timezone (manual override is "If you need someone now" on You, after Weeks). Confirmed number is 988 for US and Canada only; unconfirmed regions get an honest fallback, never a guessed hotline. The active Talk crisis card is unchanged. AI consent is a Dawn/Sage interstitial plus a You Account row.
