...
- **Home:** Stage 1 fake poster / fake card / "open box" chrome is off the production Home route. No card → honest empty, not fixture copy. Live pixel is the small top-right nav companion, not a large centered face. You-tab poster still has its own larger pixel.
