...
- Real app icon — not the Expo default splash. **Wired:** `ios.icon` = `./assets/AppIcon.icon` (SDK 54 Icon Composer). Fallback PNG `assets/AppIcon-fallback-1024.png` (RGB). Not in EAS binary 8; next production cut.
