...
## This week
Ship ATO — Wave 1. Spec: docs/ATO_PLAN_v2.md. Stages 1–7 done and on-device verified (Home shell, Sign-in/ME/Theme, Pixel, Dawn+Router, Talk, Share+Circle, Chat+Report). On Stage 8 (TestFlight sequence).
...
- Builder (Cursor) — active, Stages 1–7 shipped and on-device verified, owns docs/ME.md and docs/NOW.md directly
