...
## This week
Ship ATO — Wave 1. Spec: docs/ATO_PLAN_v2.md. Stages 1–7 done and on-device verified. Stage 8: Apple Sign-In (done), invite/referral gate (done), push+widget (done), floor-requirements sweep (**done**, pushed `ea2b4f3`), legal+landing copy (drafted, mostly live, loose ends open — see NOW.md → Left), self-reported date of birth on ME (**done**). Next: EAS build → TestFlight submission.
