...
**Latest production OTA:** `d5332b8b-7d5d-4898-bb5f-df121933b499` (commit `fb71b2d`) — Legends dev-test personas (`__DEV__` auto-login as @atodev + 4-archetype test strip on the Legends tab). Also carries the Legends tab itself and the wave30 question-deferral / invited-list client (both live since `d4919b06`). Published Sep 2, 2026. Binary 10+.
...
**EAS Update (OTA) is live as of binary 10.** Devices on binary 10+ receive JS via `eas update`. Devices on binary 8 or earlier cannot. Latest production JS: group `d5332b8b-7d5d-4898-bb5f-df121933b499` (commit `fb71b2d`, Legends dev-test personas). **OTA published Sep 2, 2026.** Prior group `d4919b06-3f7b-48f7-bb85-6659a319e577` (`d95fcfa`, question deferral + invited list; first OTA to carry the Legends tab) is superseded.
