...
**Latest production OTA:** `87207080-bbe5-4c7c-a454-d78bde988356` (commit `6e8e7b2`, runtime 1.0.0, ios+android) — batch: intake question copy + option values (show_up, talk_style, `knocks_you_off`→"Disruption", morning_cue), loneliness nudge line + library domain entry. Published Sep 3, 2026. Binary 10+. Supersedes `be169bbd` (commit `2e84220`, faster-pass gating + live category_defs).
...
**EAS Update (OTA) is live as of binary 10.** Devices on binary 10+ receive JS via `eas update`. Devices on binary 8 or earlier cannot. Latest production JS: group `87207080-bbe5-4c7c-a454-d78bde988356` (commit `6e8e7b2`, intake copy/options + loneliness). **OTA published Sep 3, 2026.** Prior groups (`c897410d`, `d5332b8b`, `11d99ff3`, `b0bdd310`, `b77e49ce`, `be169bbd`) are superseded.
