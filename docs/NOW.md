...
**Latest production OTA:** `08ae69ca-6f91-4f3d-af74-d91b348340f1` (commit `74242a6`, runtime 1.0.0, ios+android) — You share poster restyle: soft dark field + light scan plate QR (commit `e402f28`, Direction A); 5-slot bottom nav with per-user pool layout wave37 (`74242a6`). Published Sep 3, 2026. Binary 10+. Supersedes `11d99ff3` (commit `2bfbbc7`, Phase 3: Home hero card, Legends+Circle primary tabs, subscription-gated appearance modes, 20/24 type steps, `home_bootstrap`).
...
## Done
**You-tab share poster restyle OTA (commit `74242a6`, Sep 3, 2026).** Group `08ae69ca`. Poster (`share-poster.tsx`, commit `e402f28`) went Direction A — cyberpunk-minimal without neon-on-black: soft dark field `FIELD #1A1B20`, warm light scan plate `PLATE #F6F2EA`, accent corner ticks + mono `SCAN · ADD` / `ASTR//HANDLE` microcopy; QR unchanged in scan geometry (dark-on-light `QR_INK #191A1E`, explicit `ecl="M"`, `quietZone 8`, same value/size). Also carries the 5-slot bottom nav wave37 (`74242a6`). **OTA published Sep 3, 2026.** 100% production channel — no staged rollout. Supersedes `11d99ff3`.
